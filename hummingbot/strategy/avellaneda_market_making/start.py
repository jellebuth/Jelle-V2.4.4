...
def start(self):
    try:
        ...
        order_amount_shape_factor = c_map.get(
            "order_amount_shape_factor").value
        ...
        trading_intensity_buffer_size = c_map.get(
            "trading_intensity_buffer_size").value
